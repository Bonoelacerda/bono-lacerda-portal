...
const css = `@import url('https://fonts.googleapis.com/css2?family=Cormorant+Garamond:wght@400;600;700&family=Outfit:wght@300;400;500;600&display=swap'); @keyframes spin{to{transform:rotate(360deg)}} @keyframes up{from{opacity:0;transform:translateY(10px)}to{opacity:1;transform:translateY(0)}} @keyframes rin{from{transform:translateX(80px);opacity:0}to{transform:translateX(0);opacity:1}} *,*::before,*::after{box-sizing:border-box;margin:0;padding:0} :root{--bg:#f8f6f1;--w:#fff;--n:#16213e;--n2:#1a2a4a;--g:#b8860b;--g2:#d4a017;--gd:rgba(184,134,11,.12);--tx:#1c1c2e;--mu:#7a7a95;--bo:#e8e4dc;--ok:#16a34a;--er:#dc2626;--sh:0 2px 16px rgba(22,33,62,.08);--shm:0 6px 32px rgba(22,33,62,.12)} body{font-family:'Outfit',sans-serif;background:var(--bg);color:var(--tx);min-height:100vh} .alog{min-height:100vh;background:var(--n);display:flex;align-items:center;justify-content:center;position:relative;overflow:hidden} .alog::before{content:'ADVOCACIA';position:absolute;font-family:'Cormorant Garamond',serif;font-size:16vw;font-weight:700;color:rgba(255,255,255,.025);pointer-events:none;white-space:nowrap} .alc{background:rgba(255,255,255,.05);border:1px solid rgba(255,255,255,.1);border-radius:20px;padding:3rem;width:380px;position:relative;z-index:1;animation:up .4s ease} .alc h1{font-family:'Cormorant Garamond',serif;color:#fff;font-size:1.9rem;margin-bottom:.3rem} .alc>p{color:rgba(255,255,255,.45);font-size:.85rem;margin-bottom:2.5rem} .tag{display:inline-block;background:var(--gd);border:1px solid var(--g);color:var(--g2);font-size:.7rem;font-weight:600;padding:.2rem .7rem;border-radius:99px;letter-spacing:.08em;text-transform:uppercase;margin-bottom:1rem} .lf{margin-bottom:1.1rem} .lf label{display:block;color:rgba(255,255,255,.5);font-size:.75rem;font-weight:500;text-transform:uppercase;letter-spacing:.08em;margin-bottom:.5rem} .lf input{width:100%;background:rgba(255,255,255,.07);border:1px solid rgba(255,255,255,.12);border-radius:10px;padding:.8rem 1rem;color:#fff;font-family:'Outfit',sans-serif;font-size:.9rem;outline:none;transition:border-color .2s} .lf input:focus{border-color:var(--g)} .abtn{width:100%;padding:.9rem;background:var(--g);color:#fff;border:none;border-radius:10px;font-family:'Outfit',sans-serif;font-size:.95rem;font-weight:600;cursor:pointer;transition:background .2s;display:flex;align-items:center;justify-content:center;gap:.5rem} .abtn:hover{background:var(--g2)} .hint{margin-top:1.5rem;color:rgba(255,255,255,.3);font-size:.78rem;text-align:center;line-height:1.7} .aerr{color:#f87171;font-size:.82rem;margin-top:.7rem;text-align:center} .al{display:flex;min-height:100vh} .sb{width:240px;background:var(--n);position:fixed;top:0;left:0;height:100vh;display:flex;flex-direction:column;z-index:100} .sbb{padding:1.8rem 1.5rem 1.2rem;border-bottom:1px solid rgba(255,255,255,.06)} .sbb h2{font-family:'Cormorant Garamond',serif;color:#fff;font-size:1.05rem;line-height:1.3} .sbb span{color:var(--g2);font-size:.72rem;letter-spacing:.1em;text-transform:uppercase} .sbw{padding:1rem 1.5rem;display:flex;align-items:center;gap:.7rem;border-bottom:1px solid rgba(255,255,255,.06)} .av{border-radius:50%;background:var(--g);display:flex;align-items:center;justify-content:center;font-weight:700;color:var(--n);flex-shrink:0} .wn{font-size:.85rem;font-weight:600;color:#fff} .wr{font-size:.72rem;color:rgba(255,255,255,.4)} .sbnv{flex:1;padding:.75rem 0} .ni{display:flex;align-items:center;gap:.7rem;padding:.7rem 1.5rem;color:rgba(255,255,255,.5);font-size:.85rem;font-weight:500;cursor:pointer;transition:all .15s;border-left:3px solid transparent} .ni:hover{color:#fff;background:rgba(255,255,255,.04)} .ni.on{color:var(--g2);border-left-color:var(--g2);background:var(--gd)} .nbdg{margin-left:auto;background:var(--g);color:var(--n);font-size:.68rem;font-weight:700;min-width:18px;height:18px;border-radius:99px;display:flex;align-items:center;justify-content:center;padding:0 4px} .sbft{padding:1rem 1.5rem;border-top:1px solid rgba(255,255,255,.06)} .out{display:flex;align-items:center;gap:.6rem;color:rgba(255,255,255,.35);font-size:.82rem;cursor:pointer;background:none;border:none;font-family:'Outfit',sans-serif} .out:hover{color:rgba(255,255,255,.7)} .mc{margin-left:240px;flex:1;padding:2.5rem;animation:up .3s ease} .tb{display:flex;align-items:flex-start;justify-content:space-between;margin-bottom:2rem} .pt{font-family:'Cormorant Garamond',serif;font-size:1.9rem;color:var(--tx)} .ps{color:var(--mu);font-size:.85rem;margin-top:.1rem} .card{background:var(--w);border-radius:16px;border:1px solid var(--bo);box-shadow:var(--sh)} .cp{padding:1.5rem} .ct{font-family:'Cormorant Garamond',serif;font-size:1.15rem;color:var(--tx);margin-bottom:1rem;font-weight:600} .sg{display:grid;grid-template-columns:repeat(4,1fr);gap:1rem;margin-bottom:1.5rem} .st{background:var(--w);border:1px solid var(--bo);border-radius:14px;padding:1.25rem 1.5rem;box-shadow:var(--sh)} .stl{font-size:.72rem;text-transform:uppercase;letter-spacing:.08em;color:var(--mu);margin-bottom:.4rem} .stv{font-family:'Cormorant Garamond',serif;font-size:2.2rem;color:var(--tx);line-height:1} .sts{font-size:.75rem;color:var(--mu);margin-top:.3rem} .bd{display:inline-flex;align-items:center;padding:.2rem .65rem;border-radius:99px;font-size:.72rem;font-weight:600} .bg{background:#dcfce7;color:#15803d} .ba{background:#fef3c7;color:#92400e} .bb{background:#dbeafe;color:#1d4ed8} .bgr{background:#f1f5f9;color:#475569} .br{background:#fee2e2;color:#b91c1c} .tbl{width:100%;border-collapse:collapse} .tbl th{text-align:left;font-size:.72rem;text-transform:uppercase;letter-spacing:.07em;color:var(--mu);font-weight:600;padding:.75rem 1rem;border-bottom:1px solid var(--bo)} .tbl td{padding:1rem;border-bottom:1px solid var(--bo);font-size:.88rem;vertical-align:middle} .tbl tr:last-child td{border-bottom:none} .tbl tr:hover td{background:#fafaf8} .sw{position:relative;margin-bottom:1.25rem} .sw input{width:100%;padding:.75rem 1rem .75rem 2.75rem;border:1.5px solid var(--bo);border-radius:10px;font-family:'Outfit',sans-serif;font-size:.9rem;background:var(--w);color:var(--tx);outline:none;transition:border-color .2s} .sw input:focus{border-color:var(--g)} .si{position:absolute;left:.85rem;top:50%;transform:translateY(-50%);color:var(--mu);pointer-events:none} .btn{display:inline-flex;align-items:center;gap:.5rem;padding:.6rem 1.2rem;border-radius:8px;font-family:'Outfit',sans-serif;font-size:.85rem;font-weight:600;cursor:pointer;border:none;transition:all .15s} .btn-dk{background:var(--n);color:#fff} .btn-dk:hover{background:var(--n2)} .btn-ok{background:#16a34a;color:#fff} .btn-ok:hover{background:#15803d} .btn-gh{background:transparent;color:var(--mu);border:1.5px solid var(--bo)} .btn-gh:hover{border-color:var(--g);color:var(--g)} .ib{width:32px;height:32px;border-radius:8px;border:1.5px solid var(--bo);background:transparent;display:flex;align-items:center;justify-content:center;color:var(--mu);cursor:pointer;transition:all .15s} .ib:hover{border-color:var(--g);color:var(--g)} .ib.d:hover{border-color:var(--er);color:var(--er)} .ov{position:fixed;inset:0;background:rgba(22,33,62,.55);backdrop-filter:blur(4px);z-index:200;display:flex;align-items:center;justify-content:center;padding:1rem;animation:up .2s} .mo{background:var(--w);border-radius:20px;width:100%;max-width:560px;max-height:90vh;overflow-y:auto;box-shadow:var(--shm);animation:up .25s ease} .moh{display:flex;align-items:center;justify-content:space-between;padding:1.5rem;border-bottom:1px solid var(--bo)} .moh h2{font-family:'Cormorant Garamond',serif;font-size:1.3rem;color:var(--tx)} .mob{padding:1.5rem} .mof{padding:1.25rem 1.5rem;border-top:1px solid var(--bo);display:flex;gap:.75rem;justify-content:flex-end} .ff{margin-bottom:1.1rem} .ff label{display:block;font-size:.75rem;font-weight:600;color:var(--tx);text-transform:uppercase;letter-spacing:.06em;margin-bottom:.4rem} .ff input,.ff select,.ff textarea{width:100%;padding:.75rem 1rem;border:1.5px solid var(--bo);border-radius:10px;font-family:'Outfit',sans-serif;font-size:.9rem;color:var(--tx);background:var(--bg);outline:none;transition:border-color .2s} .ff input:focus,.ff select:focus,.ff textarea:focus{border-color:var(--g);background:#fff} .ff textarea{resize:vertical;min-height:80px} .fr{display:grid;grid-template-columns:1fr 1fr;gap:1rem} .tabs{display:flex;gap:.25rem;background:var(--w);padding:.3rem;border-radius:12px;border:1px solid var(--bo);width:fit-content;margin-bottom:1.25rem} .tab{padding:.5rem 1.2rem;border:none;border-radius:9px;font-family:'Outfit';font-size:.85rem;font-weight:600;cursor:pointer;transition:all .15s;background:transparent;color:var(--mu)} .tab.on{background:var(--n);color:#fff} .sr{display:flex;align-items:flex-start;gap:1rem;padding:.9rem 0;border-bottom:1px solid var(--bo)} .sr:last-child{border-bottom:none} .sc2{width:28px;height:28px;border-radius:50%;border:2px solid var(--bo);display:flex;align-items:center;justify-content:center;flex-shrink:0;cursor:pointer;transition:all .2s} .sc2.dn{background:var(--n);border-color:var(--n);color:#fff} .cw{display:flex;flex-direction:column;height:320px} .cms{flex:1;overflow-y:auto;display:flex;flex-direction:column;gap:.75rem;padding-bottom:.5rem} .mr{display:flex;gap:.5rem;align-items:flex-end} .mr.mi{flex-direction:row-reverse} .mb{max-width:70%;padding:.65rem .9rem;border-radius:14px;font-size:.85rem;line-height:1.5} .mb.th{background:var(--bg);border:1px solid var(--bo);border-bottom-left-radius:4px} .mb.mi{background:var(--n);color:#fff;border-bottom-right-radius:4px} .mt2{font-size:.68rem;color:var(--mu);margin-top:.2rem} .cir{display:flex;gap:.6rem;margin-top:.75rem;border-top:1px solid var(--bo);padding-top:.75rem} .cin{flex:1;padding:.65rem .9rem;border:1.5px solid var(--bo);border-radius:10px;font-family:'Outfit';font-size:.87rem;outline:none;color:var(--tx)} .cin:focus{border-color:var(--g)} .bsend{width:38px;height:38px;border-radius:10px;background:var(--n);border:none;display:flex;align-items:center;justify-content:center;color:var(--g2);cursor:pointer;flex-shrink:0} .bsend:hover{background:var(--n2)} .mcard{border:1px solid var(--bo);border-radius:12px;padding:1rem 1.25rem;display:flex;align-items:center;gap:1rem;margin-bottom:.75rem;background:var(--bg);transition:border-color .15s} .mdb{background:var(--n);color:#fff;border-radius:10px;width:52px;text-align:center;padding:.5rem 0;flex-shrink:0} .mdb .day{font-family:'Cormorant Garamond',serif;font-size:1.6rem;line-height:1} .mdb .mon{font-size:.65rem;text-transform:uppercase;letter-spacing:.06em;opacity:.7;margin-top:2px} .dr{display:flex;align-items:center;gap:.9rem;padding:.85rem 1rem;border-radius:10px;border:1px solid var(--bo);background:var(--bg);margin-bottom:.6rem} .dic{width:36px;height:36px;background:var(--n);border-radius:8px;display:flex;align-items:center;justify-content:center;color:var(--g2);flex-shrink:0} .uz{border:2px dashed var(--bo);border-radius:12px;padding:2rem;text-align:center;cursor:pointer;transition:all .2s;color:var(--mu);margin-bottom:1.25rem} .uz:hover{border-color:var(--g);color:var(--g);background:var(--gd)} .pw{background:var(--bo);border-radius:99px;height:6px} .pf{height:6px;border-radius:99px;background:var(--n);transition:width .4s} .ld{display:flex;align-items:center;justify-content:center;min-height:200px;flex-direction:column;gap:1rem;color:var(--mu);font-size:.9rem} .toast{position:fixed;bottom:2rem;right:2rem;background:var(--n);color:#fff;padding:.9rem 1.3rem;border-radius:12px;font-size:.85rem;z-index:9999;box-shadow:var(--shm);border-left:3px solid var(--g);animation:rin .3s ease} ::-webkit-scrollbar{width:4px}::-webkit-scrollbar-thumb{background:var(--bo);border-radius:99px}`;
...
📞 +351 21 793 1934`}, { id: "atualizacao", label: "📋 Actualização do Processo", icon: "📋", msg: (c, proc) =>`Olá ${c.name.split(” “)[0]}! 👋
...
showToast(“⏳ A confirmar reunião e criar Google Meet…”);
...
// 2. Notificação inicial ao cliente
await api.post(“notifications”,{client_id:client.id,text:`Reunião confirmada para ${m.date.split("-").reverse().join("/")} às ${m.time}. Link da videochamada a ser gerado…`,icon:“✅”,read:false});
// 3. Chamar Edge Function para criar evento + Google Meet
try{
const r=await fetch(`${SUPA_URL}/functions/v1/create-meeting-event`,{
method:“POST”,
headers:{“Content-Type”:“application/json”,“Authorization”:`Bearer ${SUPA_KEY}`,“apikey”:SUPA_KEY},
body:JSON.stringify({meeting_id:m.id})
});
const data=await r.json();
if(r.ok && data.meet_link){
const withLink={…updated,meet_link:data.meet_link,calendar_event_id:data.calendar_event_id};
setMeets(ms=>ms.map(x=>x.id===m.id?withLink:x));
setClients(cs=>cs.map(c=>c.id===client.id?{…c,meetings:(c.meetings||[]).map(x=>x.id===m.id?withLink:x)}:c));
showToast(“✅ Reunião confirmada + Google Meet criado!”);
}else{
console.error(”[confirmMeet] Meet creation failed:”,data);
showToast(`⚠️ Reunião confirmada, mas falha ao criar Meet: ${data.error||"erro desconhecido"}`);
}
}catch(e){
console.error(”[confirmMeet] Edge function error:”,e);
showToast(“⚠️ Reunião confirmada, mas erro de rede ao criar Meet.”);
}
};
...
return (
<>
<style>{`.cl-btn { position:fixed; bottom:2rem; left:2rem; width:56px; height:56px; border-radius:50%; background:linear-gradient(135deg,#1d3557,#c9a84c); border:none; cursor:pointer; box-shadow:0 4px 20px rgba(15,30,53,.35); display:flex; align-items:center; justify-content:center; z-index:1000; transition:transform .2s; } .cl-btn:hover { transform:scale(1.08); } .cl-win { position:fixed; bottom:5.5rem; left:2rem; width:360px; max-height:520px; background:#fff; border-radius:20px; box-shadow:0 8px 40px rgba(15,30,53,.2); display:flex; flex-direction:column; z-index:1000; overflow:hidden; border:1px solid #e2ddd5; animation:up .2s ease; } .cl-hdr { background:linear-gradient(135deg,#0f1e35,#1d3557); padding:1rem 1.25rem; display:flex; align-items:center; gap:.75rem; } .cl-av  { width:36px; height:36px; border-radius:50%; background:rgba(201,168,76,.2); border:1px solid rgba(201,168,76,.4); display:flex; align-items:center; justify-content:center; font-size:.75rem; font-weight:700; color:#c9a84c; flex-shrink:0; } .cl-hdr-info h4 { color:#fff; font-size:.88rem; font-weight:600; } .cl-hdr-info p  { color:rgba(255,255,255,.5); font-size:.72rem; } .cl-msgs { flex:1; overflow-y:auto; padding:1rem; display:flex; flex-direction:column; gap:.75rem; min-height:200px; max-height:340px; } .cl-msg  { display:flex; gap:.5rem; } .cl-msg.usr { flex-direction:row-reverse; } .cl-bbl  { max-width:80%; padding:.65rem .9rem; border-radius:14px; font-size:.84rem; line-height:1.5; } .cl-bbl.ai  { background:#f5f0e8; color:#1a1a2e; border-radius:4px 14px 14px 14px; } .cl-bbl.usr { background:#1d3557; color:#fff; border-radius:14px 4px 14px 14px; } .cl-inp { padding:.75rem 1rem; border-top:1px solid #e2ddd5; display:flex; gap:.5rem; } .cl-inp textarea { flex:1; border:1px solid #e2ddd5; border-radius:10px; padding:.5rem .75rem; font-family:'DM Sans',sans-serif; font-size:.84rem; resize:none; outline:none; color:#1a1a2e; background:#fafafa; } .cl-inp textarea:focus { border-color:#c9a84c; } .cl-send { width:36px; height:36px; border-radius:10px; background:#1d3557; border:none; cursor:pointer; display:flex; align-items:center; justify-content:center; color:#fff; flex-shrink:0; transition:background .2s; } .cl-send:hover { background:#0f1e35; } .cl-dot  { display:inline-flex; gap:3px; padding:.5rem; } .cl-dot span { width:6px; height:6px; border-radius:50%; background:#c9a84c; animation:bounce .8s infinite; } .cl-dot span:nth-child(2) { animation-delay:.15s; } .cl-dot span:nth-child(3) { animation-delay:.3s; } @keyframes bounce { 0%,80%,100%{transform:translateY(0)} 40%{transform:translateY(-6px)} } @media(max-width:768px){ .cl-win{width:calc(100vw - 2rem);left:1rem;bottom:5rem;} .cl-btn{bottom:5rem;left:1rem;} }`}</style>
